  ...
  return (
    <div className="py-10 px-4 space-y-4">
      <div className="flex items-center space-x-2 ">
        ...
        <div className="w-1/2 text-sm text-gray-700 p-2 border rouned-md">
      ...
      <div className="fixed w-full mx-auto max-w-md bottom-0 inset-x-0">
        <div className="flex relative items-center">
          ...
          <div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0">
            <button className="flex items-center focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 bg-orange-500 rounded-full px-3 text-sm text-white cursor-pointer hover:bg-orange-600">
              &rarr;
            </button>
          </div>
        </div>
